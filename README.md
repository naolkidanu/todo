...
**Todo app** is a website for listing todo tasks. This project mainly focus on the REACT library.
...
```sh
  cd my-folder
  git clone https://github.com/naolkidanu/todo.git
```
